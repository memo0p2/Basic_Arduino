...
int LED_IZQUIERDO = 6;    // LED izquierdo a pin digital 3
int LED_DERECHO = 9;    // LED derecho a pin digital 5
int LED_ABAJO = 3;    // LED de abajo a pin digital 6
int LED_ARRIBA = 5;   // LED de arriba a pin digital 9
